...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['video'])) {
    ...
    mysqli_query($connect_db, "INSERT INTO `videos` (`title`, `video_url`) VALUES ('$title', '$video_file')");
    echo "<script>alert('ویدیو با موفقیت آپلود شد');</script>";
}
?>
...
<body>
    <div class="login-container">
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <button type="submit" class="submit-btn">آپلود ویدیو</button>
        </form>

        <!-- لیست ویدیوها -->
        <h3 style="margin-top: 30px;">لیست ویدیوها</h3>
        <table border="1" cellpadding="10" cellspacing="0" style="width: 100%; margin-top: 20px;">
            ...
            <tbody>
                <?php
                $query_result = mysqli_query($connect_db, "SELECT * FROM `videos`");
